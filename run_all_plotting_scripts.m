...
%plot_composite_applications_results(data_dir_amg, '20260227_114514_gsvd_results.csv', '20260227_114514_gsvd_breakdown.csv', 'worst_ortho');

%% AMG 64x64 ill-conditioned random V (κ ≈ 1.5e7), b_sz=64
%plot_composite_applications_results(data_dir_amg, '20260227_114525_gsvd_results.csv', '20260227_114525_gsvd_breakdown.csv', 'worst_ortho');

%% AMG 100x100 well-conditioned (κ ≈ 84), block size sweep (skip_apps)
%plot_composite_applications_results(data_dir_100_b100, '20260227_152336_gsvd_results.csv', '20260227_152336_gsvd_breakdown.csv', 'worst_ortho');
%plot_composite_applications_results(data_dir_100_b256, '20260227_153049_gsvd_results.csv', '20260227_153049_gsvd_breakdown.csv', 'worst_ortho');
%plot_composite_applications_results(data_dir_100_b512, '20260227_153355_gsvd_results.csv', '20260227_153355_gsvd_breakdown.csv', 'worst_ortho');
